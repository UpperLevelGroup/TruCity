...
export default function AuthPage() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col justify-between bg-[#F8FCFF] overflow-x-hidden relative"
      style={{
        fontFamily:
    ...
    >
      ...
      <header className="relative z-20 px-6 lg:px-12 py-4 bg-white/90 backdrop-blur-md border-b border-slate-100 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[14px] font-medium text-[#00273D]">
          <Link
            to="/"
            className="no-underline border-b-2 border-[#FFAD01] pb-1"
            style={{ color: "#00273D" }}
          >
            HOME
          </Link>
          ...
          <button
            ...
            className="bg-transparent border-none text-[14px] font-medium text-[#00273D] hover:text-[#00466D] cursor-pointer p-0"
          >
            About
          </button>
        ...
        <div className="flex flex-wrap items-center justify-between w-full max-w-[1300px] gap-12">
          ...
          <div className="flex-1 min-w-[320px] max-w-[620px] relative z-10">
            ...
            <p
              ...
              style={{ color: "#00466D" }}
            >
              TRUCITY CONNECTS SKILLED PROFESSIONALS WITH VETTED EMPLOYERS,
              MAKING JOB SEARCHES SIMPLIER, SAFER AND MORE MEANINGFUL.
            </p>
            ...
            <div
              className="flex flex-col gap-4 text-base font-bold"
              style={{ color: "#00466D" }}
            >
              <div className="flex items-center gap-3">
                <span
                  className="font-black text-xl bg-white/90 w-7 h-7 rounded-full flex items-center justify-center shadow-sm"
                  style={{ color: "#00466D" }}
                >
                  ✓
                </span>
              ...
              <div className="flex items-center gap-3">
                ...
                <span>
                  Secure Encrypted profile & data protection
                </span>
              </div>
            </div>
          </div>
