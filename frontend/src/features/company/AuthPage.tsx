    ...
    <div className="min-h-screen flex flex-col justify-between bg-white overflow-x-hidden relative" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
      ...
      <header className="relative z-20 px-6 lg:px-12 py-4 bg-white/90 backdrop-blur-md border-b border-slate-100 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-semibold" style={{ color: '#003366' }}>
          ...
          <Link to="#" className="no-underline text-slate-600 hover:text-[#003366]">For Job Seekers</Link>
          <Link to="#" className="no-underline text-slate-600 hover:text-[#003366]">For Employers</Link>
          <Link to="#" className="no-underline text-slate-600 hover:text-[#003366]">Guidance Hub</Link>
          <Link to="#" className="no-underline text-slate-600 hover:text-[#003366]">About</Link>
          <Link to="#" className="no-underline text-slate-600 hover:text-[#003366]">Contact</Link>
        </nav>
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            style={isFormValid ? { background: 'linear-gradient(135deg, #0077b6 0%, #003366 100%)' } : {}}
          >
            Get Started
          </button>
          <button 
            ...
            style={isFormValid ? { color: '#003366' } : {}}
          >
            Sign In
          </button>
        </div>
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 lg:px-12 py-10">
        <div className="flex flex-wrap items-center justify-between w-full max-w-[1300px] gap-12">
          ...
          <div className="flex-1 min-w-[340px] flex justify-center relative z-10">
            <div className="w-full max-w-[680px] bg-white rounded-3xl p-14 lg:p-16 border border-slate-200 shadow-2xl relative">
              ...
              <div className="mb-8 text-center pt-2">
                ...
                <h2 className="text-3xl font-extrabold" style={{ color: '#ffb703' }}>Join TruCity now!</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold" style={{ color: '#003366' }}>Password (letters, numbers & symbols)</label>
                ...
                <button 
                  type="submit" 
                  className="w-full text-white p-4 rounded-xl border-none text-base font-extrabold cursor-pointer transition-colors shadow-md"
